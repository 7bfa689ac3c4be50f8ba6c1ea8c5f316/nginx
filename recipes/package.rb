...
if platform_family?('rhel')
  ...
  include_recipe 'ga-nginx::repo_passenger' if node['nginx']['repo_source'] == 'passenger'
  include_recipe 'ga-nginx::repo'           if node['nginx']['repo_source'] == 'nginx'
end
...
include_recipe 'ga-nginx::commons'
