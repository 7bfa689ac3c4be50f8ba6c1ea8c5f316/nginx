...
describe 'ga-nginx::package' do
  ...
  shared_examples_for 'all platforms' do
    it 'includes the ohai_plugin recipe' do
      expect(chef_run).to include_recipe('ga-nginx::ohai_plugin')
    end

    it 'includes the commons recipe' do
      expect(chef_run).to include_recipe('ga-nginx::commons')
    end
  ...
  shared_examples_for 'nginx repo' do
    it 'includes the nginx repo recipe' do
      expect(chef_run).to include_recipe('ga-nginx::repo')
    end
  end
